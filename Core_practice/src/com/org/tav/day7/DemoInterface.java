...
//test1 , test2 --> default show for both interface , test1 have static print() and same name static method we have in implemented class too  
...
static void hello() {
	...
	static int cal(float a ,float b) {
		return a+b;
	}
